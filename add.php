...
<div class="container">
  <form action="add.php" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" name="'student_mobile" placeholder="Enter mobile" required="">
    </div>
    <div class="form-group">
      <label for="password">Password:</label>
      <input type="password" class="form-control" name="'student_password" placeholder="Enter password" required="">
    </div>
